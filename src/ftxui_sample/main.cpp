...
// configuration step. It creates a namespace called `CPP_cmake_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", CPP_cmake_template::cmake::project_name, CPP_cmake_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", CPP_cmake_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
